...
const BookingRestaurant = props =>{
    ...
    const getAllFoodInfo =(e)=>{

        const url3 = `${URL}/foodInfo/getAllFoodInfo/${restaurant.restaurantInfoId}`
    ...
    return(
        ...
        <div className="container-xxl py-4 px-0 wow fadeInUp" data-wow-delay="0.1s">
            <div className="col-md-2"></div>
            <div className="row g-0">
            <div className="col-md-12 bg-dark d-flex align-items-center">
                        <div className="p-0 wow fadeInUp" data-wow-delay="0.2s"></div>
                        <div>
                            <br></br><br></br><br></br><center><img src={`data:image/jpg;base64,${image}`} className="card-img" style={{maxWidth:"56rem",maxHeight:"25rem"}}/></center>
                        <div className="col-12">
                            <center>
                                <div className="card-body col-md-12 bg-dark">
                                    <div style={{maxWidth:900}} className="card-text btn btn-primary w-100 py-1">
                                        <h2 style={{color:"#0F172B"}}>{restaurant.restaurantName}</h2>
                                        <h6 style={{color:"#0F172B"}}>{restaurant.restaurantAddress}</h6>
                                        <h6 style={{color:"#0F172B"}}>&#8377;{restaurant.minBookingAmountPerPerson} for 1 approx</h6>
                                        <h6 style={{color:"#0F172B"}}>Open from {restaurant.openingTime} - {restaurant.closingTime}</h6>
                                    </div>
                                 </div>
                            </center>
                        </div>
                        
                        <br/><h4 className="section-title ff-secondary text-start text-primary fw-normal">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Features</h4>                        
                            
                             <div className="col-md-3 py-2"></div>
                                 <div className="col-md-12">
                                 <div className="htmlForm-floating">
                                 <div className="form-check" style={{color:"white", marginLeft:250}}>
                        
                                        {(feature.length > 0)
                                            ? (<tbody>
                                                {feature.map(feature =>{return (<tr><td>
                                                    <input className="form-check-input" type="checkbox" value="" id="flexCheckDisabled" checked readOnly/>
                                                    <label className="form-check-label" htmlFor="flexCheckDisabled">{feature.featureName}&ensp;&ensp;&ensp; &ensp;&ensp;&ensp;&ensp;&ensp; &ensp;&ensp;&ensp;&ensp;&ensp;</label>
                                                    </td></tr>)})}
                                                    </tbody>)
                                            : (<tbody>
                                                <tr><td className="card-body">
                                                    No features.
                                                </td></tr>
                                            </tbody>)
                                        }
                        ...
                        <form > 
                            ...
                            <div className="col-md-2"></div>
                                ...
                                <div className="col-md-8">
                                    <input type="date" id="DatetimeLocal" className="form-control" onChange={(e)=>{ setBookingDate(e.target.value)}}  min="2022-09-21" required/>
                                </div>
                        <div className="col-md-2"></div>
                       <div className="col-md-2"></div>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" name="a" type="radio"  value="7.00 AM" onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 7.00 AM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input"  name="a" type="radio" value="8.00 AM" onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 8.00 AM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input"  name="a" type="radio" value="9.00 AM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 9.00 AM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input"  name="a" type="radio" value="10.00 AM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 10.00 AM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input"  name="a" type="radio" value="11.00 AM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                     ...
                     <div className="col-md-2" >    
                        <div class="dropdown">
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="12.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 12.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="1.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 1.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="2.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 2.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="3.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 3.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="4.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 4.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="5.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                       ...
                       <div className="col-md-2" >    
                        <div class="dropdown">
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="6.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 6.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="7.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 7.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="8.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 8.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="9.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 9.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="10.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                                 <label class="form-check-label">&ensp; 10.00 PM &ensp;</label>
                             </a>
                           </li>
                           <li>
                              <a class="dropdown-item">
                                 <input class="form-check-input" type="radio" name="a" value="11.00 PM"  onClick={(e)=>{ setTimeSlot(e.target.value) }}/>
                    ...
                    {/*******************************************************************************************/}
                            ...
                            <div className="col-md-8">
                                <div className="form-floating">
                                    <input type="text" className="form-control" id="text" placeholder="contact person name" onChange={(e)=>{ setGuestName(e.target.value)}}/>
                            ...
                            <div className="col-md-8">
                                <div className="form-floating">
                                    <input type="number" className="form-control" id="number" placeholder="number" onChange={(e)=>{ setNumberOfGuest(e.target.value) }}/>
                            ...
                            <div className="col-md-8">
                                <div className="form-floating">
                                    <input type="text" className="form-control" id="text" placeholder="contact person name" onChange={(e)=>{ setSpecialRequest(e.target.value);}} onBlur={(e)=>{setTableBookingAmount(numberOfGuest * restaurant.minBookingAmountPerPerson)}}/>
                                ...
                                <div className="col-md-8">
                                <div className="form-floating">
                                    <input type="number" className="form-control" id="number" placeholder="number" value={numberOfGuest * restaurant.minBookingAmountPerPerson} disabled />
                                ...
                                <div className="col-md-2"></div>
                               <div className="col-8">
                                    <button className="btn btn-primary w-100 py-3" type="submit" onClick={save}>Pay &ensp;&ensp; & &ensp;&ensp;Book</button>
                               </div>                            
                             </div>
                ...
                <div>
                        ...
                        <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
                            <br/><br/><br></br><br></br><h2 className="section-title ff-secondary text-center text-primary fw-normal">Menu at {restaurant.restaurantName}</h2><br/><br/><br/>
                        </div>
                                            ...
                                            <div className="col-lg-2"></div>
                                                        {(menuItems.length > 0)
                                                            ? (<div className="col-lg-8">
                                                                {menuItems.map(item =><div className="d-flex align-items-center"><i class="fa fa-utensils fa-3x text-primary"></i>
                                                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                                    <span style={{color:"white"}}>{item.foodName}</span>
                                                                    <span class="text-primary">&#8377; {item.unitPrice} &ensp;&ensp;&ensp;&ensp;&ensp;</span>
                                                                    </h5>
                                                                    <small class="fst-italic">{item.cusineType}</small>
                                                                    </div>
                                            ...
                                            <br/><h2 className="ff-secondary text-center text-primary ">----------------------------------------------------------------------------------</h2>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-4x text-primary">&#8377;</i>
                                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                                    <span style={{color:"white"}}>Grand Total</span>
                                                                    <span class="text-primary fa-2x"> 0 /-&ensp;&ensp;&ensp;&ensp;&ensp;</span>
                                                                </h5>
