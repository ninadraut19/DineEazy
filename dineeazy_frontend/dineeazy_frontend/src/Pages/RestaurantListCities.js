...
const RestaurantsListCities = (props) => {
    ...
    const getAllRestaurants = () => {
        ...
        let url = `${URL}/restaurantInfo/getRestaurantCity/${props.city}`
    ...
    return(
        ...
        <div className="container">
            <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 className="mb-5">Popular Restaurants in {props.city}</h1>
            </div>
...
export default RestaurantsListCities;
